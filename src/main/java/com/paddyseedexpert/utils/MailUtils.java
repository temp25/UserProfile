...
public class MailUtils {
	...
	public static String sendForgotUsernameMail(String emailAddress, String userName) {
		...
		String emailBody =  prepareEmailBody("Hello, "+emailAddress+"<br/><br/><br/>You have requested for username to sign in around, "+getTimestamp()+". Please find below details,<br/><br/>Username: <i>"+userName+"</i>"+"<br/><br/><br/><br/>"+getAutogeneratedMailDisclaimer());
